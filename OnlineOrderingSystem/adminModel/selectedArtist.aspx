<%@ Page Title="" Language="C#" MasterPageFile="~/adminModel/adminMst.Master" AutoEventWireup="true" CodeBehind="selectedArtist.aspx.cs" Inherits="adminModel.adminModel.updateArtist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width:50%;margin-left:25%;background-color:rgba(200,200,200,.5);">
        <tr>
            <td colspan="2"><center>
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="XX-Large" Text="Artist's Profile"></asp:Label>
            </center></td>
        </tr>
        <tr>
            <td>Artist ID :</td>
        ...
        <tr>
            <td>Address :</td>
            <td>
                <asp:TextBox ID="addressbox" runat="server" Enabled="False"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Show Art" />
            </td>
            <td>
