<%@ Page Title="" Language="C#" MasterPageFile="~/adminModel/adminMst.Master" AutoEventWireup="true" CodeBehind="selectedStaff.aspx.cs" Inherits="adminModel.adminModel.updateStaff" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width:50%;margin-left:25%;background-color:rgba(200,200,200,.5);">
        ...
        <tr>
            <td>
                <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Show Item" />
            </td>
            <td>
