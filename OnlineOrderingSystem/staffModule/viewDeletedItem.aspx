<%@ Page Language="C#" MasterPageFile="~/staffModule/staff.Master" AutoEventWireup="true" CodeBehind="viewDeletedItem.aspx.cs" Inherits="ItemModule.viewDeletedItem" %>
 

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    &nbsp;<title>View Deleted Item</title><style>
    </style><div>
            <u style="font-size: 20px;"><b>Item Deleted</b></u><br />
            <br />
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ItemID,StaffID" DataSourceID="SqlDataSource1" BorderColor="White" >
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Details">
                        <ItemTemplate>
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#"itemDetails.aspx?View=dsuccess&Id=" + Convert.ToInt32(Eval("ItemID")) + "&StaffID=" + Convert.ToInt32(Eval("StaffID"))%>'>View Detail</asp:HyperLink>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Item] WHERE ([Status] = @Status)">
                <SelectParameters>
                    <asp:Parameter DefaultValue="UNAVAILABLE" Name="Status" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
            <br />
