<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="modifyItem.ascx.cs" Inherits="OnlineOrderingSystem.staffModule.modifyItem" %>
<style type="text/css">
    .auto-style1 {
        width: 50%;
        border-spacing: 20px;
...
<div style="text-align: center;">
    <u style="font-size: 30px;"><b>Update Item</b></u><br /><br />
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Image], [Status] FROM [Item] WHERE (([ItemID] = @ItemID) AND ([StaffID] = @StaffID))">
    <SelectParameters>
...
<table class="auto-style1" align="center">
    <tr>
        ...
        <td><asp:TextBox ID="ItemIDTextBox" runat="server" Enabled="false"/></td>
    </tr>
    <tr>
        <td class="auto-style2">Staff ID:</td>
        <td><asp:TextBox ID="StaffIDTextBox" runat="server" Enabled="false"/></td>
    </tr>
    <tr>
    ...
    <tr>
        <td></td>
        <td>
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/staffModule/viewItem.aspx">View Item</asp:HyperLink>
        </td>
    </tr>
</table>