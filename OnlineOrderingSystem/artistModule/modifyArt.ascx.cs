...
{
    public partial class modifyArt : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["View"] == "vsuccess" && Request.QueryString["Id"] != null && Request.QueryString["AtisID"] != null)
                {
                    string id = Request.QueryString["Id"].ToString();
                    ArtIDTextBox.Text = id;
                    string artiestID = Request.QueryString["AtisID"].ToString();
                    ArtistIDTextBox.Text = artiestID;
                    ...
                    using (SqlConnection conn = new SqlConnection(cs))
                    {
                        ...
                        if (dr.HasRows)
                        {
                            Art_NameTextBox.Text = dr.GetValue(0).ToString();
                ...
                else if (Request.QueryString["View"] == "dsuccess" && Request.QueryString["Id"] != null && Request.QueryString["AtisID"] != null)
                {
        ...
        protected void Button1_Click(object sender, EventArgs e) //Update Button
        {
            ...
            int artistID = Convert.ToInt32(ArtistIDTextBox.Text);
            int artID = Convert.ToInt32(ArtIDTextBox.Text);
            ...
            if (!FileUpload1.HasFile)
            {
                try
                {
                    ...
                    using (SqlConnection conn = new SqlConnection(cs))
                    {
                        ...
                        Label1.Visible = true;
                        Label1.Text = "Art updated without update the image.";
                ...
                try
                {
                    ...
                    fileExten.ToLower() == ".gif" || fileExten.ToLower() == ".psd")
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(cs))
                        {
                            ...
                            Label1.Visible = true;
                            Label1.Text = "Art updated with image.";
                            Label1.ForeColor = System.Drawing.Color.Green;
                            HyperLink1.Visible = true;
                        }
                    }
        ...
        {
            Response.Redirect("~/artistModule/viewArt.aspx");
        }
