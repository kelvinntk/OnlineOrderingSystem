...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <title>View Deleted Art</title>
    <style>
    </style>
        <div>
            <u style="font-size: 20px;"><b>Art Deleted</b></u><br />
            <br />
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ArtID,ArtistID" DataSourceID="SqlDataSource1" BorderColor="White">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Details">
                        <ItemTemplate>
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#"artDetails.aspx?View=dsuccess&Id=" + Convert.ToInt32(Eval("ArtID")) + "&AtisID=" + Convert.ToInt32(Eval("ArtistID"))%>'>View Detail</asp:HyperLink>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
