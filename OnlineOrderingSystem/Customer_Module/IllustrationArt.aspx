<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IllustrationArt.aspx.cs" Inherits="CustomerModule.Customer_Module.IllustrationArt" MasterPageFile="~/Customer_Module/CustomerMasterPage.Master" %>
            ...
            <table>
                <tr>
                    ...
                    <td style="width:20%; padding:1em">
                        ...
                        <br />
                        <br />
                        <a href="/Customer_Module/IllustrationAddToCart.aspx?ArtID=<%#: Eval ("ArtID") %>"><input id="Button1" class="buttonStyle" type="button" value="Add To Cart" /></a>
                        <br />
                        <br />
                        <a href="/Customer_Module/IllustrationAddToWishlist.aspx?ArtID=<%#: Eval ("ArtID") %>"><input id="Button2" class="buttonStyle" type="button" value="<%# checkWishlist(Eval("ArtID") + "") %>" /></a>
