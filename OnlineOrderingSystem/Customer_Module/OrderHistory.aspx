<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderHistory.aspx.cs" Inherits="CustomerModule.Customer_Module.OrderHistory" MasterPageFile="~/Customer_Module/CustomerMasterPage.Master" %>
...
AND A.OrderID = B.OrderID">
        <SelectParameters>
            ...
            <asp:Parameter DefaultValue="SHIPPED" Name="Status" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
...
AND OrderID = @OrderID">
        <SelectParameters>
            ...
            <asp:Parameter DefaultValue="SHIPPED" Name="Status" />
