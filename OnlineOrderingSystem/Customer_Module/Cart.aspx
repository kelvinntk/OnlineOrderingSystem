...
<asp:Content ID="customerCart" ContentPlaceHolderID="CustomerContentPlaceHolder" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" CssClass="GridViewPadding" OnDataBound="GridView1_DataBound" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" DataKeyNames="CustomerID,ArtID" AllowPaging="True" AllowSorting="True" CellPadding="4" ForeColor="#333333" GridLines="None" HorizontalAlign="Center">
