<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaintingArt.aspx.cs" Inherits="CustomerModule.Customer_Module.PaintingArt" MasterPageFile="~/Customer_Module/CustomerMasterPage.Master" %>
            ...
            <table>
                <tr>
                    ...
                    <td style="width:20%; padding:1em">
                        ...
                        <br />
                        <br />
                        <a href="/Customer_Module/PaintingAddToCart.aspx?ArtID=<%#: Eval ("ArtID") %>"><input id="Button1" class="buttonStyle" type="button" value="Add To Cart" /></a>
                        <br />
                        <br />
                        <a href="/Customer_Module/PaintingAddToWishlist.aspx?ArtID=<%#: Eval ("ArtID") %>"><input id="Button2" class="buttonStyle" type="button" value="<%# checkWishlist(Eval("ArtID") + "") %>" /></a>
