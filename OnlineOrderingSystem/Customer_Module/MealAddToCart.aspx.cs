...
{
    public partial class MealAddToCart : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (balance > 0)
            {
                ...
                Response.Write("<script language='javascript'>window.alert('Item Successfully Added to Cart!');window.location='Meal.aspx';</script>");
            }
            else
            {
                Response.Write("<script language='javascript'>window.alert('ERROR! Item Stock Not Enough!');window.location='Meal.aspx';</script>");
            }
        }
