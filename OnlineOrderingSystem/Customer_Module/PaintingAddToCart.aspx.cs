...
{
    public partial class PaintingAddToCart : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (balance > 0)
            {
                ...
                Response.Write("<script language='javascript'>window.alert('Art Successfully Added to Cart!');window.location='PaintingArt.aspx';</script>");
            }
            else
            {
                Response.Write("<script language='javascript'>window.alert('ERROR! Art Stock Not Enough!');window.location='PaintingArt.aspx';</script>");
            }
        }
