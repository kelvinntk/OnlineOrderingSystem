<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Beverage.aspx.cs" Inherits="CustomerModule.Customer_Module.Beverage" MasterPageFile="~/Customer_Module/CustomerMasterPage.Master" %>
            ...
            <table>
                <tr>
                    ...
                    <td style="width:20%; padding:1em">
                        ...
                        <br />
                        <br />
                        <a href="/Customer_Module/BeverageAddToCart.aspx?ItemID=<%#: Eval ("ItemID") %>"><input id="Button1" class="buttonStyle" type="button" value="Add To Cart" /></a>
                        <br />
                        <br />
                        <a href="/Customer_Module/BeverageAddToWishlist.aspx?ItemID=<%#: Eval ("ItemID") %>"><input id="Button2" class="buttonStyle" type="button" value="<%# checkWishlist(Eval("ItemID") + "") %>" /></a>
