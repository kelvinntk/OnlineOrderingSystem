<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Meal.aspx.cs" Inherits="CustomerModule.Customer_Module.Meal" MasterPageFile="~/Customer_Module/CustomerMasterPage.Master" %>
            ...
            <table>
                <tr>
                    ...
                    <td style="width:20%; padding:1em">
                        ...
                        <br />
                        <br />
                        <a href="/Customer_Module/MealAddToCart.aspx?ItemID=<%#: Eval ("ItemID") %>"><input id="Button1" class="buttonStyle" type="button" value="Add To Cart" /></a>
                        <br />
                        <br />
                        <a href="/Customer_Module/MealAddToWishlist.aspx?ItemID=<%#: Eval ("ItemID") %>"><input id="Button2" class="buttonStyle" type="button" value="<%# checkWishlist(Eval("ItemID") + "") %>" /></a>
...
AND A.Category = 'Meal' 
AND A.ItemID = B.StaffID" InsertCommand="INSERT INTO Cart(CustomerID, ItemID, Item_Name, Quantity, Total, ImageName, ImagePath) VALUES (@CustomerID, @ItemID, @Item_Name, 1, @Total, @ImageName, @ImagePath)" UpdateCommand="UPDATE Cart SET Quantity = @Quantity, Total = @Total WHERE CustomerID = @CustomerID AND ItemID = @ItemID">
        <InsertParameters>
