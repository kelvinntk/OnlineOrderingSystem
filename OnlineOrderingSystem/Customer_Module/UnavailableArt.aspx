<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnavailableArt.aspx.cs" Inherits="CustomerModule.Customer_Module.UnavailableArt" MasterPageFile="~/Customer_Module/CustomerMasterPage.Master" %>
            ...
            <table>
                <tr>
                    ...
                    <td style="width:20%; padding:1em">
                        ...
                        <br />
                        <br />
                        <a href="/Customer_Module/UnavailableAddToWishlist.aspx?ArtID=<%#: Eval ("ArtID") %>"><input id="Button2" class="buttonStyle" type="button" value="<%# checkWishlist(Eval("ArtID") + "") %>" /></a>
