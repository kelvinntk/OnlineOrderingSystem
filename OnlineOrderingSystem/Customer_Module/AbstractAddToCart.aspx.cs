...
{
    public partial class AbstractAddToCart : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (balance > 0)
            {
                ...
                Response.Write("<script language='javascript'>window.alert('Art Successfully Added to Cart!');window.location='AbstractArt.aspx';</script>");
            }
            else
            {
                Response.Write("<script language='javascript'>window.alert('ERROR! Art Stock Not Enough!');window.location='AbstractArt.aspx';</script>");
            }
        }
