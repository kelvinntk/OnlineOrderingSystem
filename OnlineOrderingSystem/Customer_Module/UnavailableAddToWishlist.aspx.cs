...
{
    public partial class UnavailableAddToWishlist : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (wishlistExist == 1)
            {
                ...
                Response.Write("<script language='javascript'>window.alert('Art Removed from Wishlist');window.location='UnavailableArt.aspx';</script>");
            }
            else
            {
                insertWishlist(customerID, artID);

                Response.Write("<script language='javascript'>window.alert('Art Added to Wishlist!');window.location='UnavailableArt.aspx';</script>");
            }

            //Response.Redirect("UnavailableArt.aspx");
        }
